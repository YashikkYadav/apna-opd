            ...
            <v-card-text class="popup-detail">
                <v-form ref="form" v-model="isValid">
                    ...
                    <v-row>
                        ...
                        <v-col cols="6">
                            <v-text-field v-model="invoiceData.patientName" label="Patient Name" :rules="[rules.required]"
                                variant="outlined" dense :disabled="isShow">
                            </v-text-field>
                        </v-col>
                        <v-col cols="6">
                            <v-text-field v-model="invoiceData.patientPhone" label="Patient Phone" :rules="[rules.phoneNumber]"
                                variant="outlined" dense :disabled="isShow">
                            </v-text-field>
                        </v-col>
                    </v-row>
                    ...
                    <v-row>
                        ...
                        <v-col cols="8" sm="8">
                            <v-textarea v-model="invoiceData.patientAddress" class="mx-2" label="Patient Address" rows="1"
                    ...
                    <v-row>
                        <v-col cols="12">
                            <v-data-table dense :items="invoiceData.medicines" item-value="id"
                                ...
                                <template v-slot:[`item.medicineName`]="{ item, index }">
                                    <v-combobox class="table-cell py-2 service-down" variant="outlined"
                                        v-model="item.medicineName" dense hide-details @input="handleInput(item)"
    ...
    methods: {
        ...
        handleInput(item) {
            if (this.isRowFilled(item) && !this.hasEmptyRow()) {
                this.invoiceData.medicines.push({ medicineName: "", qty: "", amount: "", discount: "", total: "" });
            }
        },
        isRowFilled(item) {
