...
const NashaMukti = () => {
  ...
  const handleSearch = () => {
    setFilteredList(nashaMuktiList);
    setCurrentPage(1);
  };
            ...
            <div className="flex justify-between items-end pt-[60px] md:pt-[129px]">
              <div className="max-w-[700px] mx-auto">
                <h1 className="title-64 mb-[32px] text-center max-w-[530px] mx-auto">
                  Find Nasha Mukti Centers
                </h1>
                <p className="text-base text-white mb-[88px] text-center">
                  Get professional support and treatment for addiction recovery.
                  Find trusted de-addiction centers near you.
                </p>
              </div>
            </div>
                ...
                >
                  <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="py-[18px] sm:py-0 md:py-[18px]">
                      ...
                      <h3 className="title-32 mb-[8px]">{center.title}</h3>
