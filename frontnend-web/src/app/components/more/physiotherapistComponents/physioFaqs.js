...
const PhysioFAQS = ({ healthProfile }) => {
    ...
    return (
        ...
        >
            <div className="max-w-5xl mx-auto px-4">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 flex items-center justify-start gap-3">
