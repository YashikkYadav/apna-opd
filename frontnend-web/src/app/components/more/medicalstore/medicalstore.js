...
const MedicalStore = () => {
  ...
  useEffect(() => {
    ...
    const data = getServiceData("medical_store");
    setMedicalStoreList(data);
  ...
  const handleSearch = () => {
    setFilteredList(medicalStoreList);
    setCurrentPage(1);
  };
            ...
            <div className="flex justify-between items-end pt-[60px] md:pt-[129px]">
              <div className="max-w-[700px] mx-auto">
                ...
                <p className="text-base text-white mb-[88px] text-center">
                  Discover trusted medical stores near you for all your
                ...
                >
                  <div className="flex flex-col sm:flex-row">
                    <div className="sm:mr-[32px]">
                      <Image
                        src={store.images[0] || "/images/image_placeholder.svg"}
                        width={180}
                        height={180}
                        alt="Medical Store"
