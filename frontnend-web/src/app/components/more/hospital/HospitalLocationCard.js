...
import { FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaGlobe, FaClock } from "react-icons/fa";

export default function HospitalLocationCard() {
  return (
    <motion.div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-gray-100 rounded-2xl flex items-center p-8 min-h-[320px] md:min-h-[250px]">
          <span className="text-2xl flex items-center gap-3 text-gray-700">
            <span className="text-3xl">🗺️</span> <span className="font-semibold">Interactive Map View</span>
            <span className="font-medium text-gray-500 ml-2 text-lg">Max Super Speciality Hospital Location</span>
          </span>
        </div>
        {/* Contact Info */}
          ...
          <div>
            ...
            <div className="flex items-start gap-4 mb-4 text-lg">
              ...
              <div>
                ...
                appointments@maxhealthcare.com
              </div>
            </div>
            <div className="flex items-start gap-4 mb-4 text-lg">
            ...
            <div className="flex items-start gap-4 text-lg">
              ...
              <div>
                ...
                General: 4:00 PM - 8:00 PM<br />
                ICU: 11:00 AM - 12:00 PM, 4:00 PM - 5:00 PM
              </div>
            </div>
          </div>
        </div>
