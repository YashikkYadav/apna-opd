...
const NurseSearch = ({ searchData = {}, onSearch }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSearch({ location, nurseType, availability, gender });
  };
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-start pt-4">
          <button
            type="submit"
            className="bg-[#0C65A0] hover:bg-[#09507C] text-white text-lg font-bold px-10 py-3 rounded-xl shadow-md transition hover:scale-105"
          >
            Search Nurses
          </button>
        </div>
