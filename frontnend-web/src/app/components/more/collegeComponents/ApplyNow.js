...
export default function ApplyNow({ isOpen, onClose }) {
    ...
    const [course, setCourse] = useState("Bachelor's");
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md border border-blue-200">
                {!submitted ? (
                    <>
                        <h2 className="text-2xl font-bold text-blue-700 mb-4">Book a Free Trial</h2>
                        ...
                        <select
                            ...
                            className="w-full mb-4 px-4 py-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
                        >
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-gray-600">
                            Thanks for selecting the <span className="font-semibold text-blue-600">{course}</span>. We’ll update you further.
                        </p>
                        <button
                            onClick={onClose}
