...
const VisitClinic = ({ website_url = '{{website_url}}',
        ...
        >
            ...
            <div className="flex flex-wrap gap-6">
                {contactItems.map((item, idx) => (
                    <div
                        key={idx}
                        className="bg-white min-w-[250px] p-5 rounded-xl border-l-4 border-blue-500 hover:border-blue-700 transition-all duration-300 hover:shadow-md hover:scale-[1.02] flex items-start gap-4"
                    >
