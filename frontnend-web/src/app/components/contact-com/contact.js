            ...
            <div className="mb-[60px] md:mb-[80px]">
                ...
                >
                    <div className="flex flex-col gap-[5px]">
                        ...
                        <Form.Item name="name" rules={[{ required: true }]} className="mb-0 w-full">
                            <Input placeholder="Enter your name" className="h-[50px] text-base" />
                        </Form.Item>
                    </div>

                    <div className="flex flex-col gap-[5px]">
                        <label className="text-base text-[#2E2E2E]">Email</label>
                        <Form.Item name="email" rules={[{ required: true, type: "email" }]} className="mb-0 w-full">
                            <Input placeholder="Enter your email" className="h-[50px] text-base" />
                        </Form.Item>
                    </div>

                    <div className="flex flex-col gap-[5px]">
                        <label className="text-base text-[#2E2E2E]">Phone No</label>
                        <Form.Item name="phone" rules={[{ required: true }]} className="mb-0 w-full">
                            <Input placeholder="Enter your phone no" className="h-[50px] text-base" />
                        </Form.Item>
                    </div>

                    <div className="flex flex-col gap-[5px]">
                        <label className="text-base text-[#2E2E2E]">Description</label>
                        <Form.Item name="description" rules={[{ required: true }]} className="mb-0 w-full">
                            <TextArea placeholder="Enter your description" className="text-base" rows={5} />
                        </Form.Item>
                    </div>
