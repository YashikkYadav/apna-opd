"use client";
import { doctorDetails } from "@/app/doc-profile/page";
import { motion, AnimatePresence } from "framer-motion";
import { useState } from "react";
import { FaStar, FaChevronDown } from "react-icons/fa";

const Faqs = ({ doctorDetails }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-3xl md:text-4xl font-extrabold text-blue-700">Frequently Asked Questions</h2>
      </div>
    ...
    >
      ...
      >
        <h3 className="text-2xl font-semibold text-blue-700 mb-4">Need More Information?</h3>
